...
print OUT "vlib work\n";
print OUT "\n";
my $vhModelNames=' '.'memorymultiplexor-sv01.vhd pctosraminterface-sv06.vhd sram512kleft16bit50mhzreadreq-sv05.vhd sraminterfacewithpport-sv01.vhd wrdiptosram.vhd userpctosramtoplevel.vhd newtest.vhd';
