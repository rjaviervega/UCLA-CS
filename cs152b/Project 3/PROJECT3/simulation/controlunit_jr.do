...
force -freeze sim:/ctrlunit/dout 1110000000000001 0
run
force -freeze sim:/ctrlunit/rddone 0 0
force -freeze sim:/ctrlunit/a 1111111111111100 0
run
force -freeze sim:/ctrlunit/a 1111111111111110 0
run
run
force -freeze sim:/ctrlunit/rddone 1 0
force -freeze sim:/ctrlunit/dout 0000000000000110 0
run
force -freeze sim:/ctrlunit/rddone 0 0
force -freeze sim:/ctrlunit/pc 0000000000000110 0
run
run
run