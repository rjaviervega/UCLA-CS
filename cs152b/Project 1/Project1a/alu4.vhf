-- Vhdl model created from schematic C:\Xilinx\virtex\data\drawing\m2_1.sch - Fri Jul 09 11:31:39 2004
...
-- Vhdl model created from schematic C:\Xilinx\virtex\data\drawing\adsu4.sch - Fri Jul 09 11:31:39 2004
...
ARCHITECTURE SCHEMATIC OF ADSU4_MXILINX IS
   SIGNAL C0	:	STD_LOGIC;
   SIGNAL C1	:	STD_LOGIC;
   SIGNAL C2	:	STD_LOGIC;
   ...
   ATTRIBUTE fpga_dont_touch OF I_36_244 : LABEL IS "true";
   ATTRIBUTE fpga_dont_touch OF I_36_112 : LABEL IS "true";
   ATTRIBUTE fpga_dont_touch OF I_36_245 : LABEL IS "true";
   ATTRIBUTE fpga_dont_touch OF I_36_246 : LABEL IS "true";
...
BEGIN
   ...
   I_36_178 : FMAP
      PORT MAP (I1=>A0, I2=>B0, I3=>ADD, I4=>dummy, O=>I0);

   I_36_175 : FMAP
      PORT MAP (I1=>A1, I2=>B1, I3=>ADD, I4=>dummy, O=>I1);

   I_36_206 : FMAP
      PORT MAP (I1=>A3, I2=>B3, I3=>ADD, I4=>dummy, O=>I3);

   I_36_182 : FMAP
      PORT MAP (I1=>A2, I2=>B2, I3=>ADD, I4=>dummy, O=>I2);
   ...
   I_36_100 : XOR3
      PORT MAP (I0=>A1, I1=>B1, I2=>SUB1, O=>I1);

   I_36_57 : XOR3
      PORT MAP (I0=>A3, I1=>B3, I2=>SUB3, O=>I3);

   I_36_56 : XOR3
      PORT MAP (I0=>A2, I1=>B2, I2=>SUB2, O=>I2);

   I_36_50 : XOR3
      PORT MAP (I0=>A0, I1=>B0, I2=>SUB0, O=>I0);
...
-- Vhdl model created from schematic C:\Xilinx\virtex\data\drawing\inv4.sch - Fri Jul 09 11:31:39 2004
...
-- Vhdl model created from schematic C:\Xilinx\virtex\data\drawing\compm4.sch - Fri Jul 09 11:31:39 2004
...
-- Vhdl model created from schematic C:\Xilinx\virtex\data\drawing\ibuf4.sch - Fri Jul 09 11:31:39 2004
...
-- Vhdl model created from schematic alu4.sch - Fri Jul 09 11:31:39 2004
...
ARCHITECTURE SCHEMATIC OF alu4 IS
   ...
   ATTRIBUTE KEEP_HIERARCHY OF XLXI_124 : LABEL IS "TRUE";
   ...
   ATTRIBUTE fpga_dont_touch OF XLXI_126 : LABEL IS "true";
   ...
   ATTRIBUTE KEEP_HIERARCHY OF XLXI_127 : LABEL IS "TRUE";
   ...
   ATTRIBUTE fpga_dont_touch OF XLXI_128 : LABEL IS "true";

   COMPONENT ADSU4_MXILINX
      PORT ( A0	:	IN	STD_LOGIC; 
             A1	:	IN	STD_LOGIC; 
             A2	:	IN	STD_LOGIC; 
             A3	:	IN	STD_LOGIC; 
...
BEGIN
   ...
   XLXI_124 : ADSU4_MXILINX
      PORT MAP (A0=>A0, A1=>A1, A2=>A2, A3=>A3, ADD=>XLXN_318, B0=>B_or_one(0),
      B1=>B_or_one(1), B2=>B_or_one(2), B3=>B_or_one(3), CI=>carry,
      CO=>carryout, OFL=>dummy, S0=>add(0), S1=>add(1), S2=>add(2), S3=>add(3));
   ...
   XLXI_127 : M2_1_MXILINX
      PORT MAP (D0=>carry_in, D1=>XLXN_322, S0=>ctrl(0), O=>carry);
