...
RTDONE: LDA   ! SUCCES          ; SET SUCCESS INDICATOR
...
LTDONE: LDA   ! SUCCES          ; SET SUCCESS INDICATOR
         FIN#    2               ; TERMINATE FUNCTION
         POPX                    ; RESTORE XR
         RTN                     ; RETURN
        .PAGE                    ; ***********************
...
UPDONE: LDA   ! SUCCES          ; SET SUCCESS INDICATOR
         FIN#    2               ; TERMINATE FUNCTION
         POPX                    ; RESTORE XR
         RTN                     ; RETURN
        .PAGE                    ; ***********************
...
DNDONE: LDA   ! SUCCES          ; SET SUCCESS INDICATOR
         FIN#    2               ; TERMINATE FUNCTION
         POPX                    ; RESTORE XR
         RTN                     ; RETURN
        .PAGE                    ;
